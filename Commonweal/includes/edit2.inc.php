...
<div id="edit2" style="display:none; width: 66%; float: right;" class="win_box3">
    <div style="width: 50%; float: left; padding-right:10px;">
        <p>
            <label>姓名（*）:<br>
            <input name="edit2_name" id="edit2_name"  maxlength="20" type="text" class="win_input" placeholder="请输入真实姓名" value="<?php if(isset($edit2_name)) echo $edit2_name; else echo $_SESSION['user_name'];?>" tabindex="11">
            </label>
        </p>
        <p>
            <label>性别（*）:<br>
            <div class="win_radio">
            <label><input name="edit2_sex" type="radio" value=1 <?php if((isset($edit2_sex) && $edit2_sex==1)||(!isset($edit2_sex) && $_SESSION['user_sex']==1)) echo 'checked="true"'?> tabindex="12"/> 男</label> 
            <label><input name="edit2_sex" type="radio" value=2 <?php if((isset($edit2_sex) && $edit2_sex==2)||(!isset($edit2_sex) && $_SESSION['user_sex']==2)) echo 'checked="true"'?> tabindex="13"/> 女</label> 
            <label><input name="edit2_sex" type="radio" value=0 <?php if((isset($edit2_sex) && $edit2_sex==0)||(!isset($edit2_sex) && $_SESSION['user_sex']==0)) echo 'checked="true"'?> tabindex="14"/> 保密</label> 
            </div></label>
        </p>
        <p>
            <label>学历（*）:<br>
            <select name="edit2_qualifications" id="edit2_qualifications" class="win_select" tabindex="15">
                <option value=0 <?php if((isset($edit2_qualifications) && $edit2_qualifications==0) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==0)) echo 'selected="true"'?>>-请选择-</option>
                <option value=1 <?php if((isset($edit2_qualifications) && $edit2_qualifications==1) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==1)) echo 'selected="true"'?>>博士</option>
                <option value=2 <?php if((isset($edit2_qualifications) && $edit2_qualifications==2) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==2)) echo 'selected="true"'?>>硕士</option>
                <option value=3 <?php if((isset($edit2_qualifications) && $edit2_qualifications==3) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==3)) echo 'selected="true"'?>>本科</option>
                <option value=4 <?php if((isset($edit2_qualifications) && $edit2_qualifications==4) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==4)) echo 'selected="true"'?>>大专</option>
                <option value=5 <?php if((isset($edit2_qualifications) && $edit2_qualifications==5) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==5)) echo 'selected="true"'?>>高中</option>
                <option value=6 <?php if((isset($edit2_qualifications) && $edit2_qualifications==6) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==6)) echo 'selected="true"'?>>初中</option>
                <option value=7 <?php if((isset($edit2_qualifications) && $edit2_qualifications==7) || (!isset($edit2_qualifications) && $_SESSION['user_qualifications']==7)) echo 'selected="true"'?>>小学</option>
            </select>
            </label>
        </p>
        <p>
    ...
    <div style="width: 50%; float: right; padding-left:10px;">
        <p>
            <label>电话（*）:
            <input name="edit2_phone" id="edit2_phone" type="text" maxlength="20" class="win_input" placeholder="请输入你的联系方式"
             value="<?php if(isset($edit2_phone)) echo $edit2_phone; else echo $_SESSION['user_phone'];?>" tabindex="22">
            </label>
        </p>
        <p>
            <label>邮箱（*）:
            <input name="edit2_email" id="edit2_email" type="text" maxlength="100" class="win_input" placeholder="请输入你的邮箱地址"
             value="<?php if(isset($edit2_email)) echo $edit2_email; else echo $_SESSION['user_email'];?>" tabindex="23">           
            </label>
        </p>
        <p>
            <label>工作（*）:
            <input name="edit2_work" id="edit2_work" type="text" maxlength="100" class="win_input" placeholder="请输入你的工作内容"
             value="<?php if(isset($edit2_work)) echo $edit2_work; else echo $_SESSION['user_work'];?>" tabindex="24">
            </label>
        </p>
        <p>
            <label>简介（*）:
            <input name="edit2_info" id="edit2_info" type="text" maxlength="1000" class="win_input" placeholder="请输入你的个人介绍"
             value="<?php if(isset($edit2_info)) echo $edit2_info; else echo $_SESSION['user_info'];?>" tabindex="25">        
            </label>
        </p>
        <p>
            <label>地址（*）:
            <input name="edit2_ad2" id="edit2_ad2" type="text" maxlength="100" class="win_input" placeholder="请输入你的详细地址"
